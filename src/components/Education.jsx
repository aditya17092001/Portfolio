...
const Education = React.forwardRef((props, ref) => {
    ...
    return (
        <div ref={ref} className='overflow-hidden pb-10'>
            <div className='flex justify-center text-5xl mt-10 font-bold' id='eduHeading'>Education</div>
            <div className='flex'>
                <div className='w-3/5' id='eduDetails'>
                    <div className='w-3/4 ml-40 mt-10 rounded-3xl bg-gray-800'>
                ...
                <div className='w-2/5 flex flex-col justify-center' id='eduImg'>
