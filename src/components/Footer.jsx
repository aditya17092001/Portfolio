    ...
    return (
        <div className='h-20 mt-10' id='footer'>
            ...
            <div className='flex justify-between'>
                <div className='ml-20 mt-5'>&copy; Developer Portfolio by <span className='font-semibold text-green-400'>Udata Aditya</span>.
                </div>
                    <div className="animate-bounce h-9 w-9 mt-5 mr-20 bg-gray-700 rounded-full ml-2 flex flex-col justify-center hover:cursor-pointer shadow-sm shadow-white" onClick={scrollToHome}>
