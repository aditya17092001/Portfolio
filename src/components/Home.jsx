...
const Home = React.forwardRef((props, ref) => {
    ...
    return (
        <div ref={ref} className='flex overflow-hidden'>
            <div className='w-2/5 font-extrabold text-4xl items-center flex flex-col justify-center smpc:text-3xl' id="details">
                <div className="ml-20">
                    Hello,<br />
            ...
            <div className="flex flex-col mt-12 ml-20 w-1 h-[450px] border bg-white shadow-2xl shadow-gray-300/50 smpc:w-0 smpc:mt-8 smpc:h-[400px]" id="line"></div>
            <div className='w-3/5 items-center flex justify-center'>
                <img className='max-h-full w-4/5 smpc:h-full  smpc:w-auto' id='img' src={data} alt="" srcset="" />
            </div>            
        </div>
    )
});
