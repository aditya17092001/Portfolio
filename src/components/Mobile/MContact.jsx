    ...
    return (
        <div ref={ref} className='overflow-hidden'>
            ...
            <div className='w-full'>
                ...
                <textarea id="message" rows="4" className="block p-2.5 w-[80%] mx-auto text-sm text-white bg-gray-700 rounded-lg border border-gray-600 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Leave a comment..." required ></textarea>
            </div>
