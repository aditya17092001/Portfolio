...
const MContact = React.forwardRef((props, ref) => {
    ...
    return (
        <div ref={ref} className='overflow-hidden'>
            <div className='flex justify-center text-3xl mt-10 font-bold' id='contactHeading'>Contact</div>

            <div className='mt-10 p-5' id='contactData'>
                <div className='text-xl text-green-400 font-bold '>Get In Touch</div>
                <div className='text-base text-gray-400 font-bold mt-2'>
            ...
            <div className='mt-5'>  
                <form className="text-center" id='form'>
                    <div className='w-full'>
                            ...
                            <input type="text" id="email-address-icon" className="bg-gray-700 border border-gray-600 text-white text-sm rounded-lg block w-full pl-10 p-2.5" placeholder="John Doe" required />
                        </div>
                    </div>
            ...
            <div className='w-full'>
                ...
                <div className="relative w-[80%] mx-auto">
                    ...
                    <input type="text" id="email-address-icon" className="bg-gray-700 border border-gray-600 text-white text-sm rounded-lg block w-full pl-10 p-2.5" placeholder="johndoe@gmail.com" required />
                </div>
            </div>
            ...
            <div className='w-full'>
                ...
                <div className="relative w-[80%] mx-auto">
                    ...
                    <input type="text" id="email-address-icon" className="bg-gray-700 border border-gray-600 text-white text-sm rounded-lg block w-full pl-10 p-2.5" placeholder="+91-1234567890" required />
                </div>
            </div>

            <div className='w-full'>
                <label for="message" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white mt-3">Your Message</label>
                <textarea id="message" rows="4" className="block p-2.5 w-[80%] mx-auto text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Leave a comment..." required></textarea>
            </div>
